sudo pacman -S --needed --noconfirm polkit polkit-gnome qt6-wayland qt5-wayland grim slurp nano xorg-xhost nm-connection-editor network-manager-applet ffmpeg gdm \
